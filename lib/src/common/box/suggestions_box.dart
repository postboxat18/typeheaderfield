...
import 'package:typeheaderfield/src/common/box/suggestions_box_animation.dart';
import 'package:typeheaderfield/src/common/box/suggestions_box_focus_connector.dart';
import 'package:typeheaderfield/src/common/box/suggestions_box_scroll_injector.dart';
import 'package:typeheaderfield/src/common/box/suggestions_box_traversal_connector.dart';

import '../base/suggestions_controller.dart';
...
class SuggestionsBox<T> extends StatelessWidget {
  ...
  /// {@template typeheaderfield.SuggestionsBox.controller}
  ...
  /// {@template typeheaderfield.SuggestionsBox.scrollController}
  ...
  /// {@template typeheaderfield.SuggestionsBox.builder}
  ...
  /// {@template typeheaderfield.SuggestionsBox.decorationBuilder}
  ...
  /// {@template typeheaderfield.SuggestionsBox.transitionBuilder}
  ...
  /// {@template typeheaderfield.SuggestionsBox.animationDuration}
