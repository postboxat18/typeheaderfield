...
import 'package:typeheaderfield/src/common/field/suggestions_field.dart';
import 'package:typeheaderfield/src/common/search/suggestions_search.dart';
import 'package:typeheaderfield/src/common/base/suggestions_controller.dart';
import 'package:typeheaderfield/src/common/box/suggestions_list.dart';

import 'package:typeheaderfield/src/common/base/types.dart';
import 'package:pointer_interceptor/pointer_interceptor.dart';

/// {@template typeheaderfield.RawTypeAheadField}
...
abstract class RawTypeAheadField<T> extends StatefulWidget {
  ...
  /// {@macro typeheaderfield.SuggestionsSearch.textEditingController}
  final TextEditingController? controller;

  /// {@macro typeheaderfield.SuggestionsField.focusNode}
  final FocusNode? focusNode;

  /// {@macro typeheaderfield.SuggestionsBox.controller}
  final SuggestionsController<T>? suggestionsController;

  /// {@macro typeheaderfield.SuggestionsField.onSelected}
  final ValueSetter<T>? onSelected;

  /// {@macro typeheaderfield.SuggestionsField.direction}
  final VerticalDirection? direction;

  /// {@macro typeheaderfield.SuggestionsField.constraints}
  final BoxConstraints? constraints;

  /// {@macro typeheaderfield.SuggestionsField.offset}
  final Offset? offset;

  /// {@macro typeheaderfield.SuggestionsField.autoFlipDirection}
  final bool autoFlipDirection;

  /// {@macro typeheaderfield.SuggestionsField.autoFlipMinHeight}
  final double autoFlipMinHeight;

  /// {@macro typeheaderfield.SuggestionsField.showOnFocus}
  final bool showOnFocus;

  /// {@macro typeheaderfield.SuggestionsField.hideOnUnfocus}
  final bool hideOnUnfocus;

  /// {@macro typeheaderfield.SuggestionsField.hideOnSelect}
  final bool hideOnSelect;

  /// {@macro typeheaderfield.SuggestionsField.hideWithKeyboard}
